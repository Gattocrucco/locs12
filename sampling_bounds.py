...
def sampling_bounds(dist, nsamples, p, p_right=None):
    ...
    probability of having one or more samples below the first/above the second
    when drawing nsamples of them is p.
    ...
    dist : str, tuple or scipy.stats.rv_continuous
        ...
        tuple, the first item must be the name of a distribution, the rest
